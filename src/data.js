...
const DEFAULTS = {
  ...
  projects: [
    { id: 1, title: 'SENA - Sentimen & Narative Analityc', tech: 'political intelligence · ai agent · sentiment analysis · NLP', badge: 'AI Agent', color: 'purple' },
    { id: 2, title: 'Website PSI Papua', tech: 'next.js · tailwind · cms · responsive design', badge: 'Web App', color: 'blue' },
    { id: 3, title: 'SmartGov - Aplikasi Laporan Masyarakat', tech: 'next.js · supabase · real-time · dashboard analytics', badge: 'Web App', color: 'blue' },
    { id: 4, title: 'AI Agent Automation', tech: 'crewai · claude api · n8n · multi-agent orchestration', badge: 'Automation', color: 'cyan' },
  ],
